...
Do not set the language to Turkish. The program will give an error. 
I put circuit diagrams in png. If you make the connections this way and load the codes,
 the project will run.

PLEASE LOAD THE LIBRARIES.